    ...
    <div class="shop-content" @click="toggleShopShow">
      ...
      <div class="header-content">
        ...
        <h2 class="content-title">
          ...
          <span class="content-name">SKY città</span>
          <i class="content-icon"></i>
        </h2>
        <div class="shop-message">
          <span class="shop-message-detail">{{info.score}}</span>
          <span class="shop-message-detail">Vendita mensile {{info.sellCount}}Cibo</span>
          <span class="shop-message-detail">
            Portar
            <span>Circa{{info.deliveryTime}}Minuti</span>
          </span>
          <span class="shop-message-detail">Distanza {{info.distance}}</span>
        </div>
      </div>
    </div>
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="toggleSupportShow">
      <div class="discounts-left">
        <div class="activity" :class="supportClasses[info.supports[0].type]">
          <span class="content-tag">
            <span class="mini-tag">First</span>
          </span>
          <span class="activity-content ellipsis">Sconto del 50% per i nuovi utenti</span>
        </div>
      </div>
      <div class="discounts-right">
        {{info.supports.length}} Sale
      </div>
    </div>
      ...
      <div class="shop-brief-modal" v-show="shopShow">
        <div class="brief-modal-content">
          ...
          <ul class="brief-modal-msg">
            ...
            <li>
              <h3>{{info.sellCount}} Cibo</h3>
              <p>Vendita mensile</p>
            </li>
            <li>
              <h3>Portare</h3>
              <p>Circa{{info.deliveryTime}}minuti</p>
            </li>
            <li>
              <h3>{{info.deliveryPrice}} euro</h3>
              <p>Tassa di consegna</p>
            </li>
            <li>
              <h3>{{info.distance}}</h3>
              <p>Distanza</p>
          ...
          <div class="brief-modal-notice">
            Un negozio crntenario.Benvenuto.Acquista di più e ottieni di più.
          </div>
    ...
    <transition name="fade">
      <div class="activity-sheet" v-show="supportShow">
        <div class="activity-sheet-content">
          <h2 class="activity-sheet-title">Promozioni</h2>
          <ul class="list">
            <li class="activity-item" v-for="(support, index) in info.supports"
                :key="index" :class="supportClasses[support.type]">
            <span class="content-tag">
                <span class="mini-tag">nuova</span>
              </span>
              <span class="activity-content">Vieni subito</span>
            </li>
          </ul>
